-- CreateEnum
CREATE TYPE "SubscriptionPlan" AS ENUM ('BASIS', 'PLUS', 'UNLIMITED');
...
CREATE TABLE "Booking" (
    ...
    "hasPotteryWheel" BOOLEAN NOT NULL DEFAULT false,
    "status" "BookingStatus" NOT NULL DEFAULT 'PENDING',
    "subscriptionHoursUsed" INTEGER NOT NULL DEFAULT 0,
    "extraHoursPaid" INTEGER NOT NULL DEFAULT 0,
    "totalPriceOre" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "WeeklyUsage_userId_weekStart_key" ON "WeeklyUsage"("userId", "weekStart");
